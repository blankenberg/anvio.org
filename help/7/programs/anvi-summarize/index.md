...
Anvi-summarize lets you look at a **comprehensive overview of your <span class="artifact-n">[collection](/help/7/artifacts/collection)</span>** and its many statistics that anvi'o has calculated. 
...
* generate <span class="artifact-n">[fasta](/help/7/artifacts/fasta)</span> files containing your original contigs.   
* estimate various stats about each of your bins, including competition, redundacy, and information about all of your <span class="artifact-n">[hmm-hits](/help/7/artifacts/hmm-hits)</span>    
...
A standard run of anvi-summarize on a <span class="artifact-n">[profile-db](/help/7/artifacts/profile-db)</span> will look something like this:

<div class="codeblock" markdown="1">
anvi&#45;summarize &#45;c <span class="artifact&#45;n">[contigs&#45;db](/help/7/artifacts/contigs&#45;db)</span> \
...
When running on a <span class="artifact-n">[pan-db](/help/7/artifacts/pan-db)</span>, you'll want to instead provide the associated genomes storage database. 

<div class="codeblock" markdown="1">
anvi&#45;summarize &#45;g <span class="artifact&#45;n">[genomes&#45;storage&#45;db](/help/7/artifacts/genomes&#45;storage&#45;db)</span> \
...
If you're unsure what collections are in your database, you can run this program with the flag `--list-collections` or by running <span class="artifact-n">[anvi-show-collections-and-bins](/help/7/programs/anvi-show-collections-and-bins)</span>.
