...
You also have the option to provide a list of <span class="artifact-n">[bin](/software/anvio/help/7.1/artifacts/bin)</span> (either as a file or as a string) to analyze instead of a single <span class="artifact-n">[collection](/software/anvio/help/7.1/artifacts/collection)</span>.
