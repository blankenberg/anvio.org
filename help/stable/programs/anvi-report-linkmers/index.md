...
The resulting <span class="artifact-n">[linkmers-txt](/software/anvio/help/7.1/artifacts/linkmers-txt)</span> would include all short reads that match any of these criteria
