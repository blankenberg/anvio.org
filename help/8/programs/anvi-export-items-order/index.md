...
This program, as one might think, allows you to export a <span class="artifact-n">[misc-data-items-order](/help/8/artifacts/misc-data-items-order)</span>, outputting a <span class="artifact-n">[misc-data-items-order-txt](/help/8/artifacts/misc-data-items-order-txt)</span>.
