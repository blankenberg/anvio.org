...
This programs takes a <span class="artifact-n">[variability-profile-txt](/help/8/artifacts/variability-profile-txt)</span> and generates the information necessary to visualize its contents with <span class="artifact-p">[anvi-interactive](/help/8/programs/anvi-interactive)</span>. 

Specifically, this program outputs a directory that contains a <span class="artifact-n">[profile-db](/help/8/artifacts/profile-db)</span>, a <span class="artifact-n">[view-data](/help/8/artifacts/view-data)</span> artifact, and a <span class="artifact-n">[dendrogram](/help/8/artifacts/dendrogram)</span>. For example, if you ran this program like so: 

<div class="codeblock" markdown="1">
anvi&#45;script&#45;snvs&#45;to&#45;interactive &#45;o OUTPUT_DIR \
                                <span class="artifact&#45;n">[variability&#45;profile](/help/8/artifacts/variability&#45;profile)</span>
</div>
