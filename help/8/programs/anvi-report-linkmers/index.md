...
Reports sequences stored in a <span class="artifact-n">[bam-file](/help/8/artifacts/bam-file)</span> file that cover one of more specific nucleotide positions in a reference.
...
The resulting <span class="artifact-n">[linkmers-txt](/help/8/artifacts/linkmers-txt)</span> would include all short reads that match any of these criteria
...
Having complete links, however, will enable [oligotyping](https://besjournals.onlinelibrary.wiley.com/doi/10.1111/2041-210X.12114) analyses on **metagenomic reads** through the anvi'o program <span class="artifact-p">[anvi-oligotype-linkmers](/help/8/programs/anvi-oligotype-linkmers)</span>.
