...
This program converts a <span class="artifact-n">[linkmers-txt](/help/8/artifacts/linkmers-txt)</span> artifact into <span class="artifact-n">[oligotypes](/help/8/artifacts/oligotypes)</span> data.

A <span class="artifact-n">[linkmers-txt](/help/8/artifacts/linkmers-txt)</span> artifact describes each of your short reads that mapped to specific target nucleotide positions in a reference contig. This program counts the total occurrence of each combination in those target positions within each of your samples.

For example, if your <span class="artifact-n">[linkmers-txt](/help/8/artifacts/linkmers-txt)</span> focused on two target positions, and you ran the following:

<div class="codeblock" markdown="1">
anvi&#45;oligotype&#45;linkmers &#45;i <span class="artifact&#45;n">[linkmers&#45;txt](/help/8/artifacts/linkmers&#45;txt)</span> 
</div>
