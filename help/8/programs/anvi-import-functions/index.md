...
This program **takes in a <span class="artifact-n">[functions-txt](/help/8/artifacts/functions-txt)</span> to annotate your <span class="artifact-n">[contigs-db](/help/8/artifacts/contigs-db)</span> with <span class="artifact-n">[functions](/help/8/artifacts/functions)</span>.** Basically, if you have already have the gene functions for the contigs in your <span class="artifact-n">[contigs-db](/help/8/artifacts/contigs-db)</span> available in a file, you can import them into anvi'o using this command. 
