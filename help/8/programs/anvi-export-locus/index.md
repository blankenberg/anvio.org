...
This program lets you export selections of your <span class="artifact-n">[contigs-db](/help/8/artifacts/contigs-db)</span> around all occurrences of a user-defined anchor gene.
