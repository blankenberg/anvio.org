...
This is a tab-delimited table where each column represents an amino acid and each row represents a specific reference context (most often this will be a gene after running <span class="artifact-p">[anvi-get-codon-frequencies](/help/8/programs/anvi-get-codon-frequencies)</span>). The numbers will either refer to counts of each amino acid or percent normalizations depending on the parameters with which you ran <span class="artifact-p">[anvi-get-codon-frequencies](/help/8/programs/anvi-get-codon-frequencies)</span>.
