...
You can use this information to estimate the taxonomy of genomes, metagenomes, or collections stored in your <span class="artifact-n">[contigs-db](/help/8/artifacts/contigs-db)</span> using the program <span class="artifact-p">[anvi-estimate-trna-taxonomy](/help/8/programs/anvi-estimate-trna-taxonomy)</span>
