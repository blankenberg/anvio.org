...
When given to <span class="artifact-n">[anvi-script-filter-fasta-by-blast](/help/7.1/programs/anvi-script-filter-fasta-by-blast)</span>, which is currently the only program that uses this artifact, it expects output form 6. By default, this includes the following data columns:
